...
urlpatterns = [
   ...
   path('process-refund/<int:order_id>/', views.admin_process_refund, name='admin_process_refund'),
   path('complete-refund/<int:order_id>/', views.admin_complete_refund, name='admin_complete_refund'),
