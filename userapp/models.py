...
class OrderSeat(models.Model):
    ...
    def cancel_seat(self):
        """
        Cancel this seat booking if more than 3 hours before booking time
        ...
        # Check if less than 3 hours before booking
        time_difference = booking_datetime - current_time
        if time_difference <= timedelta(hours=3):
            return False, "Cancellation not allowed within 3 hours of booking time"
